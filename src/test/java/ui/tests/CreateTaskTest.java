...
public class CreateTaskTest extends BaseTest {
    ...
    private static final String TASK_NAME = "Task_name099";
    ...
    public void createNewTask() {
        ...
        ProjectElements.createTask1().click();
        ProjectElements.createTask2().click();
        CreateNewTaskElements.titleField().sendKeys(TASK_NAME);
        CreateNewTaskElements.markdownField().sendKeys(TASK_DESCRIPTION);
        CreateNewTaskElements.saveButton().click();
        $("tr[class*=\"board-swimlane board-swimlane\"]").shouldHave(text(TASK_NAME));
    }
